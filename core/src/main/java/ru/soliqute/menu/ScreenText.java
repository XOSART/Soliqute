...
public class ScreenText implements Screen {
    private Main main;
    ...
    public ScreenText(Main main) {
        ...
        textAbout = new String("Позже здесь вы найдете информацию,\n" +
            "пока что тут просто бессмысленный текст.\n\n\n" +
    ...
    public void render(float delta) {
        ...
        font.draw(batch, textAbout, 350, 600);
